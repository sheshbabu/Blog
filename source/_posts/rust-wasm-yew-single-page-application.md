...
description: Easy to follow guide to building SPAs using Rust, WebAssembly and Yew
keywords: Rust, Wasm, WebAssembly, Yew, SPA, Single Page Applications, Wasm Pack, Wasm Bindgen
image: /images/2020-rust-wasm-yew-single-page-application/rust-wasm-yew-single-page-application-3.png
